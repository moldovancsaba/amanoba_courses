...
**Gold standard (only acceptable form):** Every question must be standalone, grounded in the lesson, scenario-based, ask for a concrete deliverable/outcome, and use concrete educational distractors. See `docs/reference/quiz-quality-pipeline-playbook.md` for the canonical example and "why other types fail."
