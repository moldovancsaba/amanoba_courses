...
1) **Documentation = Code**
   - If we change the pipeline, we update this document and `docs/reference/quiz-quality-pipeline-playbook.md` immediately.
...
**Only questions that match this form are acceptable.** Full section: `docs/reference/quiz-quality-pipeline-playbook.md`.
...
### Documentation
- `docs/reference/quiz-quality-pipeline-playbook.md` — the lightweight playbook of rules and commands.
- `docs/reference/quiz-quality-pipeline-handover.md` — this handover document (prompt + prerequisites + rollback).
