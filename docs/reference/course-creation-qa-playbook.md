...
- `2026-course-quality-prompt.md` — full recursive QC runbook/prompt (esp. for families like `PRODUCTIVITY_2026_*`).
...
- `docs/reference/quiz-item-qa-handover.md` — workflow + commands
...
- [ ] Confirm target language(s) and that UI translations exist:
  - If locale missing in `messages/`, **stop** and create UI translations first (`docs/course-building-rules.md`).
...
- [ ] If using shorts: ensure shorts are draft until published and inherit the correct CCS (`docs/archive/delivery/2026-01/2026-01-27_RAPID_CHILDREN_COURSES_ACTION_PLAN_AND_HANDOVER.md`).
