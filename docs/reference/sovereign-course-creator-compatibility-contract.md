...
This document defines the compatibility contract between the future sovereign course-creation workflow in `amanoba_courses` and the live Amanoba application in `<USER_HOME>/Projects/amanoba`.
...
- **Compatibility SSOT:** this contract plus the live Amanoba application behavior in `<USER_HOME>/Projects/amanoba`
...
1. `CCS`
- model: `<USER_HOME>/Projects/amanoba/app/lib/models/ccs.ts`
...
2. `Course`
- model: `<USER_HOME>/Projects/amanoba/app/lib/models/course.ts`
...
3. `Lesson`
- model: `<USER_HOME>/Projects/amanoba/app/lib/models/lesson.ts`
...
4. `QuizQuestion`
- model: `<USER_HOME>/Projects/amanoba/app/lib/models/quiz-question.ts`
...
- source: `<USER_HOME>/Projects/amanoba/app/lib/lesson-content.ts`
...
- source: `<USER_HOME>/Projects/amanoba/app/api/admin/courses/route.ts`
...
- source: `<USER_HOME>/Projects/amanoba/app/api/admin/questions/route.ts`
...
- source: `<USER_HOME>/Projects/amanoba/app/api/admin/courses/import/route.ts`
