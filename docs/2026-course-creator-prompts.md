...
- You (the agent) must **read and follow**:
  ...
  - `docs/course-building-rules.md` (course creation + language prerequisites)
  - `docs/reference/quiz-quality-pipeline-handover.md` (for any quiz-related work)
  - `docs/reference/quiz-quality-pipeline-playbook.md` (for commands + reports)
  - `2026-course-quality-prompt.md` (single-source-of-truth for course QC)
...
Hard rules:
- Immediately read and treat as active rulebook: `agent_working_loop_canonical_operating_document.md`.
- If quizzes are mentioned, also read: `docs/reference/quiz-quality-pipeline-handover.md`.
...
- `Quiz blueprint`:
  ...
  - **Gold standard**: every question must be standalone, grounded in the lesson, scenario-based, ask for a concrete deliverable/outcome, and use concrete distractors (see `docs/reference/quiz-quality-pipeline-playbook.md`)
...
- **Gold standard**: questions must be standalone, grounded in lesson, scenario-based, concrete deliverable/outcome, concrete distractors (see `docs/reference/quiz-quality-pipeline-playbook.md`)
...
Hard rules:
- Immediately read and treat as active rulebook: `agent_working_loop_canonical_operating_document.md`.
- For quiz work, also read: `docs/reference/quiz-quality-pipeline-handover.md`.
...
Hard rules:
- Immediately read and treat as active rulebook: `agent_working_loop_canonical_operating_document.md`.
- Immediately read and follow: `docs/reference/quiz-quality-pipeline-handover.md`.
...
- **Gold standard**: only questions that are standalone, grounded, scenario-based, concrete deliverable, concrete distractors (see `docs/reference/quiz-quality-pipeline-playbook.md`)
