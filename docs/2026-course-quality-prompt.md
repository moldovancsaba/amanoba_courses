...
2) Immediately read and follow: `docs/reference/quiz-quality-pipeline-handover.md` and `docs/reference/quiz-quality-pipeline-playbook.md`.
   - Also read: `docs/course-building-rules.md`.
...
8) Maintain a **persistent tasklist** (required for recursion):
   - Create/update: `docs/archive/tasklists/PRODUCTIVITY_2026__ALL__<timestamp>.md`
...
2) **Tasklist** (checkboxes + next actions):
   - `docs/archive/tasklists/PRODUCTIVITY_2026__ALL__<timestamp>.md`
...
**Only questions that match this form are acceptable.** See `docs/reference/quiz-quality-pipeline-playbook.md` for the full section.
...
- Tasklist path: `docs/archive/tasklists/PRODUCTIVITY_2026__ALL__<timestamp>.md`
