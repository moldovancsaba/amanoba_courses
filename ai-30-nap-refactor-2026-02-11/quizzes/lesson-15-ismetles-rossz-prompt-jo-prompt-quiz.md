# Lesson 15 Quiz: Ismétlés: rossz prompt → jó prompt

## Question pool

### Q1
Ismétlés: rossz prompt → jó prompt: A következő helyzetben dolgozol: Elnagyolt kérésből használható draft készítése. Mi az első lépés a mérhető kimenethez?
...
### Q2
Ismétlés: rossz prompt → jó prompt: A kimenet túl általános lett. Melyik javítás adja a legnagyobb minőségugrást?
...
### Q3
Ismétlés: rossz prompt → jó prompt: Melyik lépés csökkenti legjobban ezt a kockázatot: első kör után megálló javítás?
...
### Q4
Ismétlés: rossz prompt → jó prompt: Melyik mutató bizonyítja legjobban, hogy működik a napi módszer? (2 iteráció után mérhető minőségjavulás)
...
### Q5
Ismétlés: rossz prompt → jó prompt: Melyik döntés mutatja a legjobb kezdő szemléletet?
...
### Q6
Ismétlés: rossz prompt → jó prompt: Melyik prompt ad legnagyobb eséllyel használható kimenetet első körben?
...
### Q7
Ismétlés: rossz prompt → jó prompt: Melyik sorrend adja a legkevesebb újramunkát?
