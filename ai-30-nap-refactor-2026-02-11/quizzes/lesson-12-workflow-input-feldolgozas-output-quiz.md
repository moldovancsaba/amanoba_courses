# Lesson 12 Quiz: Workflow: input → feldolgozás → output

## Question pool

### Q1
Workflow: input → feldolgozás → output: A következő helyzetben dolgozol: Bejövő leadek napi minősítése. Mi az első lépés a mérhető kimenethez?
...
### Q2
Workflow: input → feldolgozás → output: A kimenet túl általános lett. Melyik javítás adja a legnagyobb minőségugrást?
...
### Q3
Workflow: input → feldolgozás → output: Melyik lépés csökkenti legjobban ezt a kockázatot: ad hoc döntések?
...
### Q4
Workflow: input → feldolgozás → output: Melyik mutató bizonyítja legjobban, hogy működik a napi módszer? (minden lépéshez egyértelmű bemenet és kimenet)
...
### Q5
Workflow: input → feldolgozás → output: Melyik döntés mutatja a legjobb kezdő szemléletet?
...
### Q6
Workflow: input → feldolgozás → output: Melyik prompt ad legnagyobb eséllyel használható kimenetet első körben?
...
### Q7
Workflow: input → feldolgozás → output: Melyik sorrend adja a legkevesebb újramunkát?
