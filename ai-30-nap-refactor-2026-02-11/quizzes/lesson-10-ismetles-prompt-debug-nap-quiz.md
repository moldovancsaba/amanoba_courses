# Lesson 10 Quiz: Ismétlés & prompt-debug nap

## Question pool

### Q1
Ismétlés & prompt-debug nap: A következő helyzetben dolgozol: Visszatérően gyenge AI-kimenet egy csapatban. Mi az első lépés a mérhető kimenethez?
...
### Q2
Ismétlés & prompt-debug nap: A kimenet túl általános lett. Melyik javítás adja a legnagyobb minőségugrást?
...
### Q3
Ismétlés & prompt-debug nap: Melyik lépés csökkenti legjobban ezt a kockázatot: ugyanaz a hiba ismétlődik?
...
### Q4
Ismétlés & prompt-debug nap: Melyik mutató bizonyítja legjobban, hogy működik a napi módszer? (3 hibás promptból 3 javított verzió)
...
### Q5
Ismétlés & prompt-debug nap: Melyik döntés mutatja a legjobb kezdő szemléletet?
...
### Q6
Ismétlés & prompt-debug nap: Melyik prompt ad legnagyobb eséllyel használható kimenetet első körben?
...
### Q7
Ismétlés & prompt-debug nap: Melyik sorrend adja a legkevesebb újramunkát?
